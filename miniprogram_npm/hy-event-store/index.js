...
__DEFINE__(1646883490161, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1646883490162,"./event-store":1646883490163}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1646883490162, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1646883490163, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1646883490162,"./utils":1646883490164}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1646883490164, function(require, module, exports) {
...
return __REQUIRE__(1646883490161);
})()
