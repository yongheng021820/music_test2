...
__DEFINE__(1642988689997, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1642988689998,"./event-store":1642988689999}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1642988689998, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1642988689999, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1642988689998,"./utils":1642988690000}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1642988690000, function(require, module, exports) {
...
return __REQUIRE__(1642988689997);
})()
